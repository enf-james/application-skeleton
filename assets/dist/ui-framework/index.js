...
function logStyle(element) {
  ...
  var str = "button: ".concat(element.textContent, ";\nbackground-color: ").concat(style.getPropertyValue('background-color'), ";\nborder-top: ").concat(style.getPropertyValue('border-top-width'), " ").concat(style.getPropertyValue('border-top-style'), " ").concat(style.getPropertyValue('border-top-color'), ";\nborder-right: ").concat(style.getPropertyValue('border-right-width'), " ").concat(style.getPropertyValue('border-right-style'), " ").concat(style.getPropertyValue('border-right-color'), ";\nborder-bottom: ").concat(style.getPropertyValue('border-bottom-width'), " ").concat(style.getPropertyValue('border-bottom-style'), " ").concat(style.getPropertyValue('border-bottom-color'), ";\nborder-left: ").concat(style.getPropertyValue('border-left-width'), " ").concat(style.getPropertyValue('border-left-style'), " ").concat(style.getPropertyValue('border-left-color'), ";");
  console.log(str);
}

var Dialog = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(Dialog, [{
    ...
    value: function open() {
      ...
      document.body.appendChild(this).appendChild(backdrop).appendChild(dialog);
      Object.assign(this, {
        backdrop: backdrop,
        dialog: dialog
      });
    ...
    key: "backdropOnClick",
    value: function backdropOnClick(event) {
